...
interface NotificationPayload {
  ...
  type: 'registration_received' | 'registration_approved' | 'registration_rejected' | 'admin_registration_success';
...
export async function sendNotification(payload: NotificationPayload): Promise<void> {
  ...
  const templates: Record<string, string> = {
    ...
    admin_registration_success: `Admin Account Created — EmpID: ${payload.data.employeeId}. Your account has been created successfully. Please login with your provided password.`,
  };
