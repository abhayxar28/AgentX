...
import { CommissionConfigSchema, AgentOverviewQuerySchema, CreateUserSchema, UpdateUserSchema, LoginSchema, ChangePasswordSchema, AgentRegistrationInputSchema, AdminRegistrationInputSchema, RegistrationApproveSchema, RegistrationRejectSchema, LogsQuerySchema, ProductCreateSchema, ProductUpdateSchema } from '../schemas/admin.schema';
...
router.post('/auth/register-admin', validate(AdminRegistrationInputSchema), authController.registerAdmin);
