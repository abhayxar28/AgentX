...
├── frontend/
│   └── src/                           (single app for admin + agent)
│       ├── pages/
│       │   ├── auth/                  LoginPage.tsx, RegisterPage.tsx, ChangePasswordPage.tsx
│       │   ├── dashboard/             AgentDashboard.tsx
│       │   ├── calculators/           ForwardCalculator.tsx, ReverseCalculator.tsx,
│       │   │                          MDRTTracker.tsx, ActivityPredictor.tsx
...
│       │       ├── agents/            AgentOverviewPage.tsx, AgentDetailPage.tsx
│       │       ├── registrations/     RegistrationsPage.tsx
│       │       ├── users/             UserManagementPage.tsx
│       │       ├── products/          ProductManagementPage.tsx
│       │       ├── config/            CommissionConfigPage.tsx
│       │       └── logs/              AuditLogsPage.tsx
│       ├── components/                layout/, ui/, charts/
│       ├── services/                  api.ts, auth.service.ts, calculator.service.ts,
│       │                              dashboard.service.ts, policy.service.ts
│       ├── store/                     authStore.ts
│       ├── types/                     api.types.ts, calculator.types.ts, policy.types.ts
